...
public class BeaconServer extends JFrame
{
  ...
  private void initialize()
  {
    ...
    try
    {
      //loader.loadBareFileNameGame( "game6" );
      loader.loadGames( loader.defaultDir );
    }
  ...
  /**
   * Game was solved correctly
   */
  public void gameSolved()
  {
    clock.stop();
    isRunning = false ;
    infoMesg.setText( strINFO_SOLVED );
    pane.repaint();

  }// gameSolved()

  /**
   * See if entered values are good
   */
  protected void checkGrid()
  {
    if( DEBUG_LEVEL > 0 )
      System.out.println( "BeaconServer.checkGrid()" );
   ...
   * @param s  String
   */
  public void setInfoMesg( String s )
  {
    infoMesg.setText( s );
  }
  ...
  class ServListener implements ActionListener
  {
    ...
    public void actionPerformed( ActionEvent ae )
    {
      ...
      else // not the clock
      {
        ...
        else if( source == delayMenuItem )
        {
          if( DEBUG_LEVEL == 1 )
            System.out.println( "ServListener Change Delay event" );
        }
        else if( source == difficultyMenuItem )
        {
          if( DEBUG_LEVEL == 1 )
            System.out.println( "ServListener Change Difficulty event" );
        }
